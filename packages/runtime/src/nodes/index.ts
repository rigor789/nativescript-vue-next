// import { NSVViewNode, NSVNodeTypes } from './NSVElement'
...
//     if (childNode.nodeType === NSVNodeTypes.ELEMENT) {
...
// }
//
// export function removeChild(parentNode: NSVViewNode, childNode: NSVViewNode) {
//   if (!parentNode) {
//     return
//   }
//
