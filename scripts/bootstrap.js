...
files.forEach(shortName => {
  ...
  if (args.force || !pkgExists) {
    const json = {
      ...
      keywords: ['nativescript-vue'],
      author: 'Randjelovic Igor',
      license: 'MIT',
      bugs: {
        url: 'https://github.com/nativescript-vue/nativescript-vue/issues'
      },
      homepage: `https://github.com/nativescript-vue/nativescript-vue/tree/dev/packages/${shortName}#readme`
    }
